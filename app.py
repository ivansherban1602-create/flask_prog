...
import dotenv
import os
from database import Menu, Session, Users, Orders, Reservation
...
def menu_check():
    ...
    return render_template('menu_check.html', all_positions=all_positions, csrf_token=session["csrf_token"])
